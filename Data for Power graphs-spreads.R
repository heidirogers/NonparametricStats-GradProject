##Generates two sets of data that have kappa's a specified distance apart
...
##Array A (a=b=g=0 are Euler angles that give identity matrix for center, adjust
##k1 and n as needed for each case).
a=b=g=0
k1=20 #change for each case
...
##Array B (a=b=g=0 are Euler angles that give identity matrix for center, adjust
##n as needed for each case). Specify Dist to be difference kappa2-kappa1
